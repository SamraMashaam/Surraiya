...
if GROQ_API_KEY and GROQ_API_KEY.startswith("gsk_"):
    ...
    print("WARNING: GROQ_API_KEY not set or invalid. Chatbot will return placeholder responses.")
    print("Set your key in context/.env: GROQ_API_KEY=gsk_your_key_here")
...
def generate_chatbot_response(message: str, system_prompt: str, conversation_history: List[dict] = None) -> str:
    if not groq_client:
        return "Hello! I'm Mira, but I'm not fully set up yet. Please ask the developer to add a GROQ_API_KEY to the .env file."
